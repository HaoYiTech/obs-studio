...
void AutoUpdateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AutoUpdateThread *_t = static_cast<AutoUpdateThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AutoUpdateThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AutoUpdateThread.data,
      qt_meta_data_AutoUpdateThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AutoUpdateThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AutoUpdateThread.stringdata0))
        return static_cast<void*>(const_cast< AutoUpdateThread*>(this));
