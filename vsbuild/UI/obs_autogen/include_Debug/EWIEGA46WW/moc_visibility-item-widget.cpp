...
QT_MOC_LITERAL(4, 48, 11), // "LockClicked"
QT_MOC_LITERAL(5, 60, 6), // "locked"
QT_MOC_LITERAL(6, 67, 13), // "SourceEnabled"
QT_MOC_LITERAL(7, 81, 7), // "enabled"
QT_MOC_LITERAL(8, 89, 13), // "SourceRenamed"
QT_MOC_LITERAL(9, 103, 4), // "name"
QT_MOC_LITERAL(10, 108, 12) // "SourceLocked"

    },
    "VisibilityItemWidget\0VisibilityClicked\0"
    "\0visible\0LockClicked\0locked\0SourceEnabled\0"
    "enabled\0SourceRenamed\0name\0SourceLocked"
};
...
void VisibilityItemWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->LockClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->SourceEnabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->SourceRenamed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->SourceLocked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VisibilityItemWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VisibilityItemWidget.data,
      qt_meta_data_VisibilityItemWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
const QMetaObject VisibilityItemDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_VisibilityItemDelegate.data,
      qt_meta_data_VisibilityItemDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
