...
void ScriptLogWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScriptLogWindow *_t = static_cast<ScriptLogWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ScriptLogWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScriptLogWindow.data,
      qt_meta_data_ScriptLogWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScriptLogWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScriptLogWindow.stringdata0))
        return static_cast<void*>(const_cast< ScriptLogWindow*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScriptsTool *_t = static_cast<ScriptsTool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ScriptsTool::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScriptsTool.data,
      qt_meta_data_ScriptsTool,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScriptsTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScriptsTool.stringdata0))
        return static_cast<void*>(const_cast< ScriptsTool*>(this));
    return QWidget::qt_metacast(_clname);
}
