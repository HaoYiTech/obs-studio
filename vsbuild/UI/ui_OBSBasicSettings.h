...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 801, 741));
        ...
        openStatsOnStartup->setObjectName(QStringLiteral("openStatsOnStartup"));
        ...
        formLayout_31->setObjectName(QStringLiteral("formLayout_31"));
        ...
        doubleClickSwitch->setObjectName(QStringLiteral("doubleClickSwitch"));
        ...
        studioPortraitLayout->setObjectName(QStringLiteral("studioPortraitLayout"));

        formLayout_31->setWidget(1, QFormLayout::FieldRole, studioPortraitLayout);

        multiviewLayout = new QComboBox(groupBox_11);
        multiviewLayout->setObjectName(QStringLiteral("multiviewLayout"));

        formLayout_31->setWidget(2, QFormLayout::FieldRole, multiviewLayout);

        label_64 = new QLabel(groupBox_11);
        label_64->setObjectName(QStringLiteral("label_64"));

        formLayout_31->setWidget(2, QFormLayout::LabelRole, label_64);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 818, 697));
        ...
        advOutputReplayTab->setObjectName(QStringLiteral("advOutputReplayTab"));
        verticalLayout_22 = new QVBoxLayout(advOutputReplayTab);
        verticalLayout_22->setObjectName(QStringLiteral("verticalLayout_22"));
        advReplayBuf = new QCheckBox(advOutputReplayTab);
        advReplayBuf->setObjectName(QStringLiteral("advReplayBuf"));

        verticalLayout_22->addWidget(advReplayBuf);

        line_4 = new QFrame(advOutputReplayTab);
        ...
        advReplayBufferGroupBox->setObjectName(QStringLiteral("advReplayBufferGroupBox"));
        ...
        advRBSecMaxLabel->setObjectName(QStringLiteral("advRBSecMaxLabel"));

        formLayout_30->setWidget(0, QFormLayout::LabelRole, advRBSecMaxLabel);

        advRBSecMax = new QSpinBox(advReplayBufferGroupBox);
        advRBSecMax->setObjectName(QStringLiteral("advRBSecMax"));
        advRBSecMax->setSuffix(QStringLiteral(" sec"));
        ...
        advRBMegsMaxLabel->setObjectName(QStringLiteral("advRBMegsMaxLabel"));
        ...
        audioSourceWidget->setGeometry(QRect(0, 0, 800, 69));
        audioSourceScrollArea->setWidget(audioSourceWidget);

        formLayout->setWidget(9, QFormLayout::SpanningRole, audioSourceScrollArea);
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, audioMsg);

        audioMsg_2 = new QLabel(audioPage);
        audioMsg_2->setObjectName(QStringLiteral("audioMsg_2"));
        audioMsg_2->setText(QStringLiteral(""));
        audioMsg_2->setWordWrap(true);
        audioMsg_2->setProperty("themeID", QVariant(QStringLiteral("warning")));

        formLayout->setWidget(11, QFormLayout::FieldRole, audioMsg_2);

        label_65 = new QLabel(audioPage);
        label_65->setObjectName(QStringLiteral("label_65"));

        formLayout->setWidget(7, QFormLayout::LabelRole, label_65);

        meterDecayRate = new QComboBox(audioPage);
        meterDecayRate->setObjectName(QStringLiteral("meterDecayRate"));

        formLayout->setWidget(7, QFormLayout::FieldRole, meterDecayRate);

        peakMeterType = new QComboBox(audioPage);
        peakMeterType->setObjectName(QStringLiteral("peakMeterType"));

        formLayout->setWidget(8, QFormLayout::FieldRole, peakMeterType);

        label_66 = new QLabel(audioPage);
        label_66->setObjectName(QStringLiteral("label_66"));

        formLayout->setWidget(8, QFormLayout::LabelRole, label_66);
        ...
        hotkeyWidget->setGeometry(QRect(0, 0, 818, 697));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 803, 761));
        ...
        disableAudioDucking = new QCheckBox(advAudioGroupBox);
        disableAudioDucking->setObjectName(QStringLiteral("disableAudioDucking"));

        formLayout_27->setWidget(1, QFormLayout::FieldRole, disableAudioDucking);
        ...
        advNetworkGroupBox->setObjectName(QStringLiteral("advNetworkGroupBox"));
        ...
        verticalLayout_17->addWidget(advNetworkGroupBox);
    ...
    void retranslateUi(QDialog *OBSBasicSettings)
    {
        ...
        groupBox_15->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.General", 0));
        ...
        enableAutoUpdates->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.EnableAutoUpdates", 0));
        openStatsOnStartup->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.OpenStatsOnStartup", 0));
        groupBox_16->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output", 0));
        ...
        groupBox_14->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.Projectors", 0));
        ...
        groupBox_13->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.SysTray", 0));
        systemTrayEnabled->setText(QApplication::translate("OBSBasicSettings", "Enable", 0));
        ...
        groupBox_11->setTitle(QApplication::translate("OBSBasicSettings", "Basic.TogglePreviewProgramMode", 0));
        doubleClickSwitch->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.SwitchOnDoubleClick", 0));
        studioPortraitLayout->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.StudioPortraitLayout", 0));
        label_64->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.MultiviewLayout", 0));
        ...
        label_63->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.Adv.FFmpeg.GOPSize", 0));
        advOutFFUseRescale->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.Adv.Rescale", 0));
        advOutFFIgnoreCompat->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.Adv.FFmpeg.IgnoreCodecCompat", 0));
        ...
        advReplayBuf->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.UseReplayBuffer", 0));
        advReplayBufferGroupBox->setTitle(QApplication::translate("OBSBasicSettings", "ReplayBuffer", 0));
        advRBSecMaxLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.SecondsMax", 0));
        advRBHotkeyLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.HotkeyMessage", 0));
        advRBMegsMax->setSuffix(QApplication::translate("OBSBasicSettings", " MB", 0));
        advRBMegsMaxLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.MegabytesMax", 0));
        advOutTabs->setTabText(advOutTabs->indexOf(advOutputReplayTab), QApplication::translate("OBSBasicSettings", "ReplayBuffer", 0));
        ...
        channelSetup->insertItems(0, QStringList()
         ...
         << QApplication::translate("OBSBasicSettings", "2.1", 0)
         << QApplication::translate("OBSBasicSettings", "4.0", 0)
         << QApplication::translate("OBSBasicSettings", "4.1", 0)
         << QApplication::translate("OBSBasicSettings", "5.1", 0)
         << QApplication::translate("OBSBasicSettings", "7.1", 0)
        );
        ...
        label_65->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate", 0));
        meterDecayRate->clear();
        meterDecayRate->insertItems(0, QStringList()
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Fast", 0)
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Medium", 0)
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Slow", 0)
        );
        meterDecayRate->setCurrentText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Fast", 0));
        peakMeterType->clear();
        peakMeterType->insertItems(0, QStringList()
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.PeakMeterType.SamplePeak", 0)
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.PeakMeterType.TruePeak", 0)
        );
        label_66->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.PeakMeterType", 0));
        ...
        fpsCommon->setItemText(2, QApplication::translate("OBSBasicSettings", "24 NTSC", 0));
        ...
        advAudioGroupBox->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio", 0));
        monitoringDeviceLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Audio.MonitoringDevice", 0));
        disableAudioDucking->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Audio.DisableAudioDucking", 0));
        ...
        advNetworkGroupBox->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Network", 0));
        label_27->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Network.BindToIP", 0));
        enableNewSocketLoop->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Network.EnableNewSocketLoop", 0));
        enableLowLatencyMode->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Network.EnableLowLatencyMode", 0));
    } // retranslateUi
